...
})({"8OSZf":[function(require,module,exports) {
...
parcelHelpers.export(exports, "Carousel", ()=>Q);
parcelHelpers.export(exports, "Fancybox", ()=>Oe);
parcelHelpers.export(exports, "Panzoom", ()=>I);
    ...
    processType(t) {
        ...
        if (n = e.match(/(youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|shorts\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i)) {
            const s = this.optionFor(t, Pt), { nocookie: o } = s, a = function(t, e) {
                ...
                "nocookie"
            ]), r = `www.youtube${o ? "-nocookie" : ""}.com`, l = Mt(e, a), c = encodeURIComponent(n[2]);
...
let $t = class extends _ {
    ...
    attach() {
        const t = this, e = t.instance;
        e.on("initSlide", t.onInitSlide), e.state === B.Init ? e.on("initSlides", t.onInitSlides) : t.onInitSlides(), e.on([
            "change",
...
},{}]},["8OSZf","kcX1v"], "kcX1v", "parcelRequire4474")
